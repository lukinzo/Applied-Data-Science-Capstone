...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',
                                    options=[{'label': 'All Sites', 'value': 'ALL'},{'label': unique_sites[0], 'value': unique_sites[0]},{'label': unique_sites[1], 'value': unique_sites[1]},{'label': unique_sites[2], 'value': unique_sites[2]},{'label': unique_sites[3], 'value': unique_sites[3]}],
                                    value='ALL',
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(
            site_df,
            names='class',  # Using 'Class' to differentiate between success (1) and failure (0)
...
def update_scatter_plot(entered_site, payload_range):
    ...
    # Return the figure for rendering in the graph component
    return fig
